...
function returnStats3G_carrier($carrier, $pp, $selection, $startDate, $endDate){

      
  if (isset($carrier, $pp, $selection, $startDate, $endDate)) {
      ...
      $sql_string_end = " FROM ranPU.Acceptance_Stats_3G_daily, ranPU.revenue_figures WHERE (Acceptance_Stats_3G_daily.Date BETWEEN '".$startDate."' AND '".$endDate."') AND mid(Acceptance_Stats_3G_daily.CELLNAME,10,5)='".$carrier."' AND (".$selectedCells.")"; 
